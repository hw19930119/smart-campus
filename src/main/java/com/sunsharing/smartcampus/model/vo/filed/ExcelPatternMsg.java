...
public class ExcelPatternMsg {
    ...
    public static final String DATE1_MSG = "请输入正确的日期格式：yyyy/MM/dd";

    //日期格式 yyyy-MM-dd
    public static final String DATE2 = "(([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|" +
        "((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})(0[48]|[2468][048]|[13579][26])|" +
        "((0[48]|[2468][048]|[3579][26])00))-02-29)$";
    public static final String DATE2_MSG = "请输入正确的日期格式：yyyy-MM-dd";
    ...
    public static final String DATE3_MSG = "请输入正确的日期格式：yyyyMMdd";
    ...
    public static final String DATE_TIME1_MSG = "请输入正确的日期格式：yyyy-MM-dd HH:mm:ss";
    ...
    public static final String DATE_TIME2_MSG = "请输入正确的日期格式：yyyy/MM/dd HH:mm:ss";
    ...
    public static final String DATE_TIME3_MSG = "请输入正确的日期格式：yyyyMMddHHmmss";
    ...
    public static final String DATE_TIME4_MSG = "请输入正确的日期格式：yyyyMMddHHmmssSSS";
    ...
    public static final String DATE_TIME5_MSG = "请输入正确的日期格式：yyyyMMdd HH:mm:ss";
